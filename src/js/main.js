...
i sökbaren, samt koppla url.dataprovider till nominatium för att få upp det på en karta. */

/*Ska visas när man sökt på konstverket: 
*dcTitleLangAware 
* dcDescription 
*/ 
...
async function getMapInfo(artInfoPlace){
    try {
        ...
        console.log("kunde inte läsa in information...")
    }
}
